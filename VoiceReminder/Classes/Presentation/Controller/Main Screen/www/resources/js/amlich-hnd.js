...
var THANGAMLICH =new Array("Tháng Giêng","Tháng Hai","Tháng Ba","Tháng Tư","Tháng Năm","Tháng Sáu","Tháng Bảy","Tháng Tám","Tháng Chín","Tháng Mười","Tháng Mười Một","Tháng Chạp"); 
...
function getSelectedMonth() {
	...
	for (idx = 0; idx < arr.length; idx++) {
		if (arr[idx] == "mm") {
			...
			currentDate = parseInt(arr[idx+1]);
		} else if (arr[idx] =="ref") {
