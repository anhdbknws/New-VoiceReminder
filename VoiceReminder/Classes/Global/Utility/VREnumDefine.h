...
typedef NS_ENUM(NSInteger, REPEAT_TYPE) {
    ...
    REPEAT_TYPE_NERER   = 0,
    REPEAT_TYPE_MONDAY  = 1,
    REPEAT_TYPE_TUESDAY   = 2,
    REPEAT_TYPE_WEDNESDAY  = 3,
    REPEAT_TYPE_THURSDAY = 4,
    REPEAT_TYPE_FRIDAY  = 5,
    REPEAT_TYPE_SATURDAY  = 6,
    REPEAT_TYPE_SUNDAY  = 7,
    REPEAT_TYPE_EVERYDAY  = 8,
};
